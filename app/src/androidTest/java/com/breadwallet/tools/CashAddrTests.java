...
public class CashAddrTests {
    ...
    public void testLegacyP2PKHAddressConversion(){
        ...
        final String cash = "bitcoincash:qq8ntjzxt2zqpvxqhra53uqttg3rf9m50y6kers5hq";
    ...
    public void testLegacyP2SHAddressConversion(){
        ...
        final String cash = "bitcoincash:pzyjepg4rmm8yx8v0sc6svac255ta2md2y9l0edptq";

        CashAddr result = CashAddr.fromLegacy(legacy);
        assertThat(result.toString(), CoreMatchers.is(CoreMatchers.equalTo(cash)));
        assertThat(result.toLegacy(), CoreMatchers.is(CoreMatchers.equalTo(legacy)));
    }
}
